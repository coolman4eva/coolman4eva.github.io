...
var cat1 = ($("input[@name=q1]:checked").val() != "Linear"); 
           
var cat2 = ($("input[@name=q2]:checked").val() != "Bent");  

var cat3 = ($("input[@name=q3]:checked").val() != "Dihydrogen monosulfide");  

var cat4 = ($("input[@name=q4]:checked").val() != "<strong>N<sub>2</sub>O<sub>5</sub>");  

var cat5 = ($("input[@name=q5]:checked").val() != "None of these "); 

var cat6 = ($("input[@name=q6]:checked").val() != "CH<sub>4</sub>");  

var cat7 = ($("input[@name=q7]:checked").val() != "0"); 

var cat8 = ($("input[@name=q8]:checked").val() != "Liquid");  

var cat9 = ($("input[@name=q9]:checked").val() != "Nitrogen trioxide"); 

var cat10 = ($("input[@name=q10]:checked").val() != "First");  
